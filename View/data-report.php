...
<body class="body">
    ...
    <div class="container mt-3">
            <span class="title-page-list">
                ...
                <?php
                  echo '<a href="report.php" class="nav-link">
        ...
        <table id="data-student" class="display nowrap stripe order-column cell-border" style="width:100%">
            ...
            if (isset($_POST["program"])) {
                echo '<thead>
                    ...
                    $query = "SELECT card_number, personne.nom as personne_nom, personne.prenom as personne_prenom, date_naissance, lieu_naissance,
                        ...
                        statut_name, nom_groupe, personne.creation_date as date_creation,
                    ...
                    WHERE entreprise.code_entreprise = '$code_entreprise' AND 
                        ...
                        AND users.code_user = groupe.code_user AND program.id_program = '$id_program' AND groupe.id_program = '$id_program' AND
                        personne.id_program = '$id_program' AND personne.id_group = groupe.id_group AND statut.id_statut = personne.id_statut
            ...
            elseif(isset($_POST["group"])){
                echo '<thead>
                    ...
                    $query = "SELECT card_number, personne.nom as personne_nom, personne.prenom as personne_prenom, date_naissance, lieu_naissance,
                        personne.telephone_1 as telephone_1, personne.telephone_2 as telephone_2, personne.adresse as adresse, personne.email as email, 
                        statut_name, program_name, personne.creation_date as date_creation,
                        personne.date_exp as date_expiration, users.nom as user_nom, users.prenom as user_prenom
                    FROM entreprise, program, users, groupe, personne, statut 
                    WHERE entreprise.code_entreprise = '$code_entreprise' AND 
                        program.code_entreprise = '$code_entreprise' AND users.code_entreprise = '$code_entreprise' AND users.code_user = program.code_user 
            ...
            elseif(isset($_POST["person"])){
                echo '<thead>
                    ...
                    $query = "SELECT card_number, personne.nom as personne_nom, personne.prenom as personne_prenom, date_naissance, lieu_naissance,
                        personne.telephone_1 as telephone_1, personne.telephone_2 as telephone_2, personne.adresse as adresse, personne.email as email, 
                        statut_name, nom_groupe, program_name, personne.creation_date as date_creation,
                        personne.date_exp as date_expiration, users.nom as user_nom, users.prenom as user_prenom
                    FROM entreprise, program, users, groupe, personne, statut 
                    WHERE entreprise.code_entreprise = '$code_entreprise' AND 
                        program.code_entreprise = '$code_entreprise' AND users.code_entreprise = '$code_entreprise' AND users.code_user = program.code_user 
                        AND users.code_user = groupe.code_user AND program.id_program = groupe.id_program AND personne.id_program = program.id_program 
                        AND personne.id_group = groupe.id_group AND personne.id_person = '$id_person' AND statut.id_statut = personne.id_statut
                    ORDER BY personne_nom ASC";
                    $result = $conn->query($query);
