    ...
    if (mysqli_num_rows($result) > 0) {
        while ($row = mysqli_fetch_assoc($result)) {
            echo '<div class="mb-3">
                ...
                <input type="text" class="form-control" name="name" value="'.$row["program_name"].'" id="exampleFormControlInput1" >
            </div>
            <div class="mb-3">
...
?>
            <button type="submit" name="submit" class="text-white mb-5 btn btn-brand">Save</button>
